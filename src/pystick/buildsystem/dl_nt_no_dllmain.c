...
/** Pystick: this is commented out so someone creating a DLL with statically embedded Python can provide his/her own
    DllMain
    */
#if 0
...
void pystick_process_attach(HANDLE hInst) {
    PyWin_DLLhModule = hInst;
    // 1000 is a magic number I picked out of the air.  Could do with a #define, I spose...
    LoadString(hInst, 1000, dllVersionBuffer, sizeof(dllVersionBuffer));
